...
namespace Blocker
{
   // public class ChaseCamera : GameObject3D
    ...
    //   // public ChaseCamera(Vector3 PositionOffset, Vector3 TargetOffset, Vector3 RelativeCameraRotation, int width, int height)
    //   // {
    ...
    //   //     this.Projection = Matrix.CreatePerspectiveFieldOfView(MathHelper.PiOver4, 1.6f, 1f, 10000);
    //   //     // Matrix.CreatePerspectiveFieldOfView(MathHelper.ToRadians(45), aspectRatio, 0.1f, 100000.0f);
